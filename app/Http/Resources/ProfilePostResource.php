...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'user', type: 'object', description: 'Author of the post (the profile owner). Lets grids share the same tile interactions as the feed.', properties: [
            new OA\Property(property: 'id', type: 'string', format: 'uuid'),
