...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'is_child', type: 'boolean', description: 'Whether this person is a child of the user.'),
        new OA\Property(property: 'avatar', type: 'string', nullable: true, description: 'Signed URL of the person\'s avatar.'),
        new OA\Property(property: 'avatar_thumbnail', type: 'string', nullable: true, description: 'Signed URL of the 300×300 avatar thumbnail.'),
