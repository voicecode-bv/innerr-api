...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'user_id', type: 'integer', nullable: true, description: 'When set, this person is linked to a user account in the same circle(s).'),
        new OA\Property(property: 'created_by_user_id', type: 'integer', description: 'The user that created this person.'),
        ...
        new OA\Property(property: 'circle_ids', type: 'array', items: new OA\Items(type: 'integer'), description: 'IDs of the circles this person belongs to. Only included when the `circles` relation is loaded.'),
