...
class User extends Authenticatable implements HasLocalePreference
{
    ...
    protected $attributes = [
        'notification_preferences' => '{"post_liked":true,"post_commented":true,"comment_liked":true,"comment_replied":true,"new_circle_post":true,"circle_invitation_accepted":true}',
    ];
